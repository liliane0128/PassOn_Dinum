...
export function ResumeSection({
  ...
  onRequestEdit?: () => void;
  id?: string;
  /** Called when the editor is closed, with the text to store. */
  ...
  function handleToggleEdit() {
    ...
    // Closing the editor is when the edit is meant to stick; saving on every
    // keystroke would be one PATCH per character.
