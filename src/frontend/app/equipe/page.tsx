            ...
            <div className="mx-auto max-w-5xl">
              ...
              <div className="rounded-2xl border border-gray-200 bg-white shadow-card">
                <ul className="divide-y divide-gray-100">
                  {/* Julie Bonnet's own team (see lib/mock-data.ts and
                      MANAGER_PERSONA): Marie is the one row with something to
                      show for it, everyone else is here to make the list read
                      as a real team rather than a single departing agent. */}
